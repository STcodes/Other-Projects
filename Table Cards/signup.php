<?php 
    ...
    if(!empty($_POST)){
        ...
        if($isSucces){
            $db = Database::connect();
            $statement = $db->prepare('INSERT INTO client(client.name, client.password) VALUES (?,?)');
...
<body>
    <div id="container">
        ...
        <h2><span id="log">Sign</span><span id="in">up</span></h2>
        <span id="ligne"></span>
        <form action="signup.php" method="POST">
            ...
            <button type = "submit" name="connecter">Sign up</button>
            <div id="message"  style="color:red;"><?php echo $Error; ?></div>
        </form>
        <a href="connexion.php" style="float:right; color:white; font-weight:bold; margin:5px 0px 0px 80%; font-size:1.1rem;">Log in</a>
    </div>
